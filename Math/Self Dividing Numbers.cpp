...
//Sol 2: Save all results in advance, and output the numbers in the [left, right] interval each time.
class Solution {
public:
    vector<int> selfDividingNumbers(int left, int right) {
        const int SIZE = 339;
